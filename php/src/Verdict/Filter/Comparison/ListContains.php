...
/**
 * Compile our configuration to a "list contains" (in_array) clause.
...
class ListContains extends ComparisonAbstract implements FilterInterface, ComparisonInterface
{
    /**
     * @inheritDoc
     */
